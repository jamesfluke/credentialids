pipeline {
    ...
    stages {
        ...
        stage('CredentialIDs') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'jenkins-credentials', passwordVariable: '11c2847a43dfeb26d025f6241cc4ecdafa', usernameVariable: 'credentialidtoken')]) {
